...
public abstract class MaskFieldUtil
{
    ...
    public static void onlyAlfaValue(TextField field)
    {
        field.lengthProperty().addListener((observableValue, number, number2)
                ->
        {
            try
            {
                String value = field.getText();
                value = value.replaceAll("[^\\p{IsAlphabetic} ]", "");
                field.setText(value);
    ...
    public static void onlyNumericValue(TextField field)
    {
        field.lengthProperty().addListener((observableValue, number, number2)
                ->
        {
            ...
            {
                String value = field.getText();
                value = value.replaceAll("[^\\p{IsDigit} ]", "");
                field.setText(value);
    ...
    public static void onlyAlfaNumericValue(TextField field)
    {
        field.lengthProperty().addListener((observableValue, number, number2)
                ->
        {
